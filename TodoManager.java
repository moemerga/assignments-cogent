...
public class TodoManager {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    System.out.print("Enter the taskId, please: ");
                    int taskId = input.nextInt();
                    System.out.print("Enter the taskName, please: ");
                ...
                case 2:
                    ...
                    if (index == -1) {
                        ...
                        System.out.print("Enter the new taskName: ");
                        taskName = input.next();
                        tasks[index].setTaskName(taskName);
                    }
                    break;
                case 3:
                    System.out.print("Enter the taskId of the task you want to delete: ");
                    taskId = input.nextInt();
                    index = -1;
                    for (int i = 0; i < tasks.length; i++) {
                        if (tasks[i].getTaskId() == taskId) {
                    ...
                    break;
                case 4:
                    System.out.print("Enter the taskId of the task you want to search: ");
                    taskId = input.nextInt();
                    index = -1;
                    for (int i = 0; i < tasks.length; i++) {
                        if (tasks[i].getTaskId() == taskId) {
